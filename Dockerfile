...
RUN Rscript -e "install.packages(c('datarium','PerformanceAnalytics','memisc','summarytools'))"
...
RUN Rscript -e "install.packages(c('gtExtras','gt','gtsummary','flextable','queuecomputer','simmer','simmer.plot'))"
